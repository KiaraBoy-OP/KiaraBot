...
* **Major Updates:**
     ...
     *For Example:* ``GIT_REPO`` = ``KiaraBoy-OP/Plugins``
* **Bugs Fixes:**
    - **Remove BG:** ``.rmbg`` command was not uploading output image.
     Now it is fixed and improved for better use.
    - **Sangmata:** Due to some problems in sangmata official bot, kiarabot was also affected by it.
...
By ~ `Ừʂɛɤẞø† Network { 🇮🇳 } <https://t.me/Kiara_X_Upadates>`_
=================================================
